...
async function claim(){
  ...
  try{
    ...
    if(!r.ok){
      const messages={
        access_denied:'Неверный код доступа',
        try_later:'Слишком много попыток входа. Повторите позже.',
        temporary_error:'Временная ошибка авторизации. Повторите через минуту.'
      };
